...
;
;       10/16/13 Added to FORWARD package with no change other than the name. SG
;
;-
;
;###########################################################################
...
PRO FOR_COLORBAR, BOTTOM=bottom, CHARSIZE=charsize, COLOR=color, DIVISIONS=divisions, $
